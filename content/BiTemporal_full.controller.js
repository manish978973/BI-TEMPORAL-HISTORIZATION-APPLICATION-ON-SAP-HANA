sap.ui.controller("content.BiTemporal_full", {
...
onFilter1Invoices : function (oEvent) {

			// build filter array
			var aFilter = [];
			var sQuery = oEvent.getParameter("query");
			if (sQuery) {
			//	aFilter.push(new sap.ui.model.Filter("CUSTOMER_NAME", sap.ui.model.FilterOperator.Contains, sQuery));
...
onFilter2Invoices : function (oEvent) {
			...
			if (sQuery) {
			//	aFilter.push(new sap.ui.model.Filter("CUSTOMER_NAME", sap.ui.model.FilterOperator.Contains, sQuery));
				aFilter.push(new sap.ui.model.Filter("CUSTOMER_NUMBER", sap.ui.model.FilterOperator.Contains, sQuery));
			}
...
onFilter3Invoices : function (oEvent) {
